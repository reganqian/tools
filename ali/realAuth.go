...
func RealCheck(regionId, accessKeyId, accessKeySecret, orderNo, metaInfo, userId, headUrl string, sceneId int64) (_result *sdk.InitFaceVerifyResponse, _err error) {
	...
	tryErr := func() (_e error) {
		...
		requestInitFaceVerify := &sdk.InitFaceVerifyRequest{}
		requestInitFaceVerify.SceneId = tea.Int64(sceneId)
...
func RealDescribeFaceVerify(regionId, accessKeyId, accessKeySecret, certifyId string, sceneId int64) (_result *sdk.DescribeFaceVerifyResponse, _err error) {
	tryErr := func() (_e error) {
		defer func() {
			if r := tea.Recover(recover()); r != nil {
				_e = r
		...
		requestDescribeFaceVerify := &sdk.DescribeFaceVerifyRequest{}
		requestDescribeFaceVerify.SceneId = tea.Int64(sceneId)
		requestDescribeFaceVerify.CertifyId = tea.String(certifyId)
		responseDescribeFaceVerify, _err := client.DescribeFaceVerify(requestDescribeFaceVerify)
		if _err != nil {
			return _err
		}
